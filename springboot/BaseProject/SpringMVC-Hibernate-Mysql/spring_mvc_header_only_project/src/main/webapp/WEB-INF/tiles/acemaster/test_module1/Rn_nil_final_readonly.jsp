...
<div class="clearfix">
<input   value="${rn_nil_final_updt.textfield1}" type="text" name=textfield1 id=textfield1  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input   value="${rn_nil_final_updt.textfield2}" type="text" name=textfield2 id=textfield2  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input   value="${rn_nil_final_updt.textfield3}" type="text" name=textfield3 id=textfield3  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input value="${rn_nil_final_updt.textfield4}"  value="${rn_nil_final_updt.textfield4}" type="text" name=textfield4 id=textfield4  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input value="${rn_nil_final_updt.textfield5}"  value="${rn_nil_final_updt.textfield5}" type="text" name=textfield5 id=textfield5  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input   value="${rn_nil_final_updt.textfield6}" type="text" name=textfield6 id=textfield6  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input   value="${rn_nil_final_updt.textfield7}" type="text" name=textfield7 id=textfield7  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input   value="${rn_nil_final_updt.textfield8}" type="text" name=textfield8 id=textfield8  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input value="${rn_nil_final_updt.textfield9}"  value="${rn_nil_final_updt.textfield9}" type="text" name=textfield9 id=textfield9  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<%@include file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_final_ext_Readonly.jsp"%>
</div>
</div>
</div>
</div>
...
<script>
document.getElementById('textfield5').onclick = function() {  
  document.getElementById('textfield5').removeAttribute('readonly');
};
</script>
<script>
document.getElementById('textfield6').onclick = function() {  
  document.getElementById('textfield6').removeAttribute('readonly');
};
</script>
<script>
document.getElementById('textfield7').onclick = function() {  
  document.getElementById('textfield7').removeAttribute('readonly');
};
</script>
<script>
document.getElementById('textfield8').onclick = function() {  
  document.getElementById('textfield8').removeAttribute('readonly');
};
</script>
<script>
document.getElementById('textfield9').onclick = function() {  
  document.getElementById('textfield9').removeAttribute('readonly');
};
</script>
<script>
var readonly = true;
