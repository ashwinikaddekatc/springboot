   package com.realnet.test_module1.model;
...
@Entity
@Table(name = "RN_NIL_FINAL")
public class	Rn_nil_final
{
@Id
...
@Column(name = "TEXTFIELD5")
private String 	textfield5;
@Column(name = "TEXTFIELD6")
private String 	textfield6;
@Column(name = "TEXTFIELD7")
private String 	textfield7;
@Column(name = "TEXTFIELD8")
private String 	textfield8;
@Column(name = "TEXTFIELD9")
