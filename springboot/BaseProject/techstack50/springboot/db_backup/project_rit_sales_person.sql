...
CREATE TABLE `sales_person` (
  ...
  `sales_sales_id` int DEFAULT NULL,
  PRIMARY KEY (`pid`),
  KEY `FKlhkgabikhu80xwu68yso8rt24` (`sales_sales_id`)
...
INSERT INTO `sales_person` VALUES (87,'vishal',86),(88,'satyam',86),(90,NULL,89);
...
-- Dump completed on 2021-03-09 19:22:33
