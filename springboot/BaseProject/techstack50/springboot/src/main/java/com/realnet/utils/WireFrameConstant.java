...
public class WireFrameConstant {
	...
	public static final String DT_LONGTEXT = "textarea";
	...
	public static final String DT_PHONEMASKED = "phonemasked";
	public static final String DT_DATE = "date";
	public static final String FIELD_CHECKBOX = "checkbox";
	public static final String FIELD_TOGGLEBUTTON = "togglebutton";
	...
	public static final String FIELD_PASSWORDMASKED= "passwordmasked";
