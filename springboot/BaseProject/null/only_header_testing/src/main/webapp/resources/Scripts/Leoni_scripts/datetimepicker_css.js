...
var imageFilesPath = "../../Content/sample/images2/";
...
function RenderCssCal(bNewCal)
{
	...
	winCalData = "<span id='calSpanbass' style='cursor:auto;'>";
	...
	if (!winCal)
	{
		...
		//span.setAttribute.onmouseout = "hidden";
		document.body.appendChild(span);
		winCal = document.getElementById(calSpanID);

//		var div = document.getElementById("calSpanbass");
//		alert(div);
...
//		}
		//$('#span').setAttribute('onmouseout', 'hidden');
//		var span1=document.createElement("span").onmouseover = function () { autoclosewin(); };
//		alert(span1);
	}
...
//    alert('Hiiii');
//    $("#calSpanbass").focusout(function () {
//        alert('Hiiii');
//        $("#calSpanbass").prop('visibility', 'hidden');
//    });
//});