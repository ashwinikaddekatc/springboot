...
<link
	href="http://cdn-na.infragistics.com/igniteui/2019.2/latest/css/themes/infragistics/infragistics.theme.css"
	rel="stylesheet" />
<link
	href="http://cdn-na.infragistics.com/igniteui/2019.2/latest/css/structure/infragistics.css"
	rel="stylesheet" />
</head>
<body>
			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">rn_nil_test1</li>
					</ul>
				</div>
					...
					<div class="page-header">
						<h1>
							...
							<div style="float: right; padding-right: 5%;">
								<a href="#myModel" id="${rn_rb_reports_t_updt.id}"> <i
									class="fa fa-ticket" aria-hidden="true" data-toggle="modal"
									data-target="#myModal"> </i>
								</a>
							</div>
						</h1>
						<div>
							<a href="user_status_update?id=${rn_nil_test1_updt_id}">
								<button type="button" id="button2" name="button2"
									class="btn btn-success btn-sm btn-next">update</button>
							</a>
						</div>
									...
									<div id="fuelux-wizard-container">
										<div class="step-content pos-rel">
											<div class="step-pane active" data-step="1">
												<form action="rn_nil_test1_update_submit"
													class="form-horizontal" id="Regi" method="Post">
													<div class="table-header"
														style="margin-bottom: 30px; margin-top: 30px;">
														section1</div>
													<table>
														<c:forEach var="rn_nil_test1_updt"
															items="${rn_nil_test1_update}" varStatus="status">
															<input type="hidden" name="id" id="id"
																value="${rn_nil_test1_updt.id}" />
															<tr>
															</tr>
															<tr>
															</tr>
															...
															<tr>
																<td>
																	<div class="form-group"
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test1_updt.textfield1}"
																					type="text" name=textfield1 id=textfield1
																					class="form-control" />
																			</div>
																		</div>
																	</div>
																...
																<td>
																	<div class="form-group"
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test1_updt.textfield2}"
																...
																<td>
																	<div class="form-group"
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test1_updt.textfield3}"
															...
															<tr>
																<td>
																	<div class="form-group"
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test1_updt.textfield4}"
																					type="text" name=textfield4 id=textfield4
																					class="form-control" />
																			</div>
																		</div>
																	</div>
													...
													<c:forEach var="rn_nil_test1_updt"
														...
														<%@include
															file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_test1_ext_Update.jsp"%>
													</c:forEach>
												...
												<div class="modal fade" id="myModal" role="dialog">
													<div class="modal-dialog">
														...
														<div class="modal-content">
															...
															<c:forEach var="rn_nil_test1_updt"
																items="${rn_nil_test1_update}" varStatus="status">
																<input value="${rn_rb_reports_t_updt.id}" type="hidden"
																	name="id" id="id" class="col-xs-12 col-sm-4" />
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		<label data-error="wrong" data-success="right">Account</label>
																		<input type="text" id="acc_id" name="acc_id"
																			class="form-control validate"
																			value="${rn_nil_test1_updt.account_id}" readonly>
																	</div>
																</div>
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																...
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="created_by" name="created_by"
																			class="form-control validate"
																			value="${rn_nil_test1_updt.created_by}" readonly>
																	</div>
																</div>
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="creation_date"
																			...
																			value="${rn_nil_test1_updt.creation_date}" readonly>
																	</div>
																</div>
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="last_updated_by"
																			name="last_updated_by" class="form-control validate"
																			value="${rn_nil_test1_updt.last_updated_by}" readonly>
																	</div>
																</div>
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="last_update_date"
																			name="last_update_date" class="form-control validate"
																			value="${rn_nil_test1_updt.last_update_date}"
																			readonly>
																	</div>
																</div>
															</c:forEach>
	...
	<script
		src="<c:url value='cdnjs.cloudflare.com/ajax/libs/easy-autocomplete/1.3.5/jquery.easy-autocomplete.min.js'/>"
		type="text/javascript">
