...
<a href="rn_nil_test2_entryform"> <i class="fa fa-plus fa-1g" aria-hidden="true" title="Add New Report"></i></a>
</div>
</h1>
</div><!-- /.page-header -->
<div class="row">
...
<%@include file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_test2_add_grid.jsp"%>
</tr>
</thead>
<tbody>
<c:forEach var="rn_nil_test2" items="${rn_nil_test2}" varStatus="status">
<tr>	<td class="center"><a href="rn_nil_test2_readonly?id=${rn_nil_test2.id}"><i class="fa fa-eye green" aria-hidden="true"></i>/</a><a href="rn_nil_test2_update?id=${rn_nil_test2.id}"><i class="fa fa-edit red" aria-hidden="true"></i>/</a><a href="rolenewviewreports?user_id=${rn_userlist.id}"><i class="fa fa-graduation-cap" aria-hidden="true"></i></a></td>
<td class="center">${rn_nil_test2.textfield1}</td>
<td class="center">${rn_nil_test2.textfield2}</td>
<td class="center">${rn_nil_test2.textfield3}</td>
<td class="center">${rn_nil_test2.textfield4}</td><%@include file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_test2_add_grid2.jsp"%>
</tr>
</c:forEach>
</tbody> 
</table>
