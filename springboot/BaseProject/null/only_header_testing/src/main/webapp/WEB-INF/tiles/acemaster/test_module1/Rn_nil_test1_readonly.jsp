									...
									<div id="fuelux-wizard-container">
										<div class="step-content pos-rel">
											<div class="step-pane active" data-step="1">
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test1_updt.textfield4}"
																					value="${rn_nil_test1_updt.textfield4}" type="text"
																					name=textfield4 id=textfield4 class="form-control"
																					readonly />
																			</div>
																		</div>
																	</div>
												...
												<%@include
													file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_test1_ext_Readonly.jsp"%>
											</div>
										</div>
									</div>
								</div>
