...
<h1>rn_nil_test2<div style="float: right; padding-right: 5%;"><a href="rn_form_builder_extension"><i class="fa fa-paper-plane-o fa-1x" aria-hidden="true" title="help"></i></a></div></h1>
</div>
<div class="row">
<div class="col-xs-12">
...
<form action="rn_nil_test2_submit" class="form-horizontal" id="Regi" method="Post">
...
<div class="clearfix">
<input value="${rn_nil_test2_updt.textfield1}"  type="text" name=textfield1 id=textfield1   class="form-control"/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input value="${rn_nil_test2_updt.textfield2}"  type="text" name=textfield2 id=textfield2   class="form-control"/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input value="${rn_nil_test2_updt.textfield3}"  type="text" name=textfield3 id=textfield3   class="form-control"/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input value="${rn_nil_test2_updt.textfield4}"  type="text" name=textfield4 id=textfield4   class="form-control"/>
</div>
</div>
</div>
</td>
</table>
<%@include file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_test2_extension.jsp"%>
