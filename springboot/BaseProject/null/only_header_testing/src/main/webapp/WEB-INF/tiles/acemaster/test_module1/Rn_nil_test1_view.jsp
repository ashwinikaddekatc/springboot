					...
					<div class="page-header">
						<h1>
							...
							<div style="float: right; padding-right: 5%;">
								<a href="rn_form_builder_extension"><i
									class="fa fa-paper-plane-o fa-1x" aria-hidden="true"
									title="help"></i></a>
							</div>
						</h1>
					</div>
										...
										<div class="step-content pos-rel">
											<div class="step-pane active" data-step="1">
												<div class="table-header"
													...
													section1</div>
												<form action="rn_nil_test1_submit" class="form-horizontal"
													id="Regi" method="Post">
													<input type="hidden" name="test" id="test" value="" />
													<table>
														<tr>
															<td style="display: none;"><input type="text"
																id="id" class="col-xs-10 col-sm-11" name="id" value="" /></td>
														<tr>
															<td>
													...
													<%@include
														file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_test1_extension.jsp"%>
													<div class="wizard-actions">
														<button type="submit" class="btn btn-success center"
															onclick="submitForms()">button1</button>
													</div>
												</form>
											</div>
										</div>
