...
<form action="rn_nil_test2_update_submit" class="form-horizontal" id="Regi" method="Post">
<div class="table-header" style="margin-bottom: 30px; margin-top: 30px;"> section1</div> 
<table>
<c:forEach var="rn_nil_test2_updt" items="${rn_nil_test2_update}" varStatus="status">
<input type="hidden" name="id" id="id" value="${rn_nil_test2_updt.id}" />
<tr>
<tr>
<td>
...
<div class="clearfix">
<input   value="${rn_nil_test2_updt.textfield1}" type="text" name=textfield1 id=textfield1  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input   value="${rn_nil_test2_updt.textfield2}" type="text" name=textfield2 id=textfield2  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input   value="${rn_nil_test2_updt.textfield3}" type="text" name=textfield3 id=textfield3  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<div class="col-xs-12 col-sm-9">
<div class="clearfix">
<input value="${rn_nil_test2_updt.textfield4}"  value="${rn_nil_test2_updt.textfield4}" type="text" name=textfield4 id=textfield4  class="form-control"  readonly/>
</div>
</div>
</div>
</td>
...
<%@include file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_test2_ext_Readonly.jsp"%>
</div>
</div>
</div>
</div>
