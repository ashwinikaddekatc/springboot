			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">rn_nil_test2</li>
					</ul>
				</div>
				<div class="page-content">
					<div class="page-header">
						...
						<div>
							<a href="user_insert?id=${rn_nil_test2_updt_id}">
									...
									<div id="fuelux-wizard-container">
										<div class="step-content pos-rel">
											<div class="step-pane active" data-step="1">
												<form action="rn_nil_test2_update_submit"
													class="form-horizontal" id="Regi" method="Post">
													<div class="table-header"
														style="margin-bottom: 30px; margin-top: 30px;">
														section1</div>
													<table>
														<c:forEach var="rn_nil_test2_updt"
															items="${rn_nil_test2_update}" varStatus="status">
															<input type="hidden" name="id" id="id"
																value="${rn_nil_test2_updt.id}" />
															<tr>
															</tr>
															<tr>
															</tr>
															...
															<tr>
																<td>
																	<div class="form-group"
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test2_updt.textfield1}"
																...
																<td>
																	<div class="form-group"
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test2_updt.textfield2}"
																...
																<td>
																	<div class="form-group"
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test2_updt.textfield3}"
															...
															<tr>
																<td>
																	<div class="form-group"
																		...
																		<div class="col-xs-12 col-sm-9">
																			<div class="clearfix">
																				<input value="${rn_nil_test2_updt.textfield4}"
													...
													<c:forEach var="rn_nil_test2_updt"
														...
														<%@include
															file="/WEB-INF/tiles/acemaster/test_module1/rn_nil_test2_ext_Update.jsp"%>
													</c:forEach>
																...
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="acc_id" name="acc_id"
																			...
																			value="${rn_nil_test2_updt.account_id}" readonly>
																	</div>
																</div>
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																...
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="created_by" name="created_by"
																			class="form-control validate"
																			value="${rn_nil_test2_updt.created_by}" readonly>
																	</div>
																</div>
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="creation_date"
																			...
																			value="${rn_nil_test2_updt.creation_date}" readonly>
																	</div>
																</div>
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="last_updated_by"
																			...
																			value="${rn_nil_test2_updt.last_updated_by}" readonly>
																	</div>
																</div>
																<div class="modal-body mx-3">
																	<div class="md-form mb-5">
																		...
																		<input type="text" id="last_update_date"
																			...
																			value="${rn_nil_test2_updt.last_update_date}"
																			readonly>
																	</div>
																</div>
															</c:forEach>
