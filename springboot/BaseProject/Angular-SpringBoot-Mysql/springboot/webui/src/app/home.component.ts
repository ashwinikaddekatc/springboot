...
export class HomeComponent implements OnInit {
    ...
    public appHeaderItems = [
        ...
        { label: 'Departments', href: '/home/departments', subNav: [] },
        { label: 'Fields', href: '/home/fields', subNav: [] },
        { label: 'Builder', href: '/home/builder', subNav: [] },

        // { label: 'Sales', href: '/home/sales', subNav: [] },
