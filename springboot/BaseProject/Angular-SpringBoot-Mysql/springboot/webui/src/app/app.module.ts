...
import { NewFieldsComponent } from './pages/new-fields/new-fields.component';
...
import { AddbuilderComponent } from './pages/builder/addbuilder/addbuilder.component';
import { AddExtComponent } from './pages/departments/extensions/add-ext/add-ext.component';
import { AddLabelComponent } from './pages/departments/extensions/add-label/add-label.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ReadonlydepartmentComponent,

    UpdateupdatedepartmentsComponent,
