		...
		for(Rn_Forms_Component_Setup component: components) {
			...
			if(WireFrameConstant.DT_TEXTFIELD.equalsIgnoreCase(type)) {
				...
				dynamic_entry_form_html.append("<tr>\r\n" + 
						...
						"                  <td>\r\n" + 
						"                      <input colspan=\"2\" type=\"text\" formControlName=\"comp" + i + "\" placeholder=\"" + drop_value + "\"\r\n");
				...
				if(WireFrameConstant.FIELD_DROPDOWN.equalsIgnoreCase(type)) {
					...
					" <tr>\r\n" + "        <td style=\"width:125px;\">" + label
							+ " </td>\r\n"
							+ "        <td><select colspan=\"2\" style=\"width:180px\" type=\"text\" [formControlName]=\"comp"
							+ i + "><option value=\"null\">Choose Field Type</option>"
									+ " <option *ngFor=\"let type of field_type\" [ngValue]=\"type\">{{ type }}</option></td>\r\n" + "    </tr>\n"
							);
...
//			//dropdown
				 ...
				 * <td class="left">
                                <select colspan="2" formControlName="type" selected="null" style="width:180px"
                                    class="clr-dropdown" formControlName="department">
		...
		//add lines
		dynamic_entry_form_html.append("<button type=\"button\" class=\"btn btn-primary button1\" (click)=\"onAddLines()\">\r\n"
