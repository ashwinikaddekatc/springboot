...
public class angspringboot_form_only_header_Builder  {
 ...
 @Value("${angularProjectPath}")
	...
	@GetMapping(value = "/angspringboot_form_only_header_Builder")
 ...
 for (Rn_Fb_Line rn_Fb_linefield : rn_fb_lines) {
 	...
 	if(rn_Fb_linefield.getType_field().equals("datetime"))
 	 ...
 	 if(rn_Fb_linefield.getType_field().equals("autocomplete"))
 	 {
 		sbohaddhtmlCode.append(	"<div class=\"clr-col-md-4 clr-col-sm-12\" style=\"margin-bottom: 20px;\">\r\n"+
 			 			"                  <label>" +rn_Fb_linefield.getFieldName()+ ": </label>\r\n" + "   \r\n"+	 			
 						" <input type=\"text\"  ormControlName=\""+rn_Fb_linefield.getFieldName()+"\" list=\"datalistauto\" placeholder=\"Enter " +rn_Fb_linefield.getFieldName()+ "\" />\r\n"
...
"  submitted = false;" + "\r\n" );
 for (Rn_Fb_Line rn_Fb_linefield : rn_fb_lines) {
 	 ...
 	 if(rn_Fb_linefield.getType_field().equals("dropdown"))
 	 {
 		...
 		sbohaddtsCode.append(" dropdownval=[\"yes\",\"no\",\"dont know\"];" + "\r\n");
 	 }
 	 
 	 if(rn_Fb_linefield.getType_field().equals("autocomplete"))
 	 {
 	
 		sbohaddtsCode.append("   autocomlist= [\"1000\",\"1001\",\"1002\",\"1003\",\"1004\",\"1005\",\"1006\",\"1007\",\"1008\",\"1009\",\"1010\"];" + "\r\n");
...
"" + "\r\n" );
 		...
 		sbohaddtsCode.append(" <a (click)=\"goToWhoColumns()\" style=\" display: block;margin-left: 100%;\">\r\n"
...
File file1 = new File(angularProjectPath + "/src/main/java/com/realnet/Module/salesnew/" + module_name + "/controller/");
if(!file1.exists()) {
	file1.mkdirs();
}
File file2 = new File(angularProjectPath + "/src/main/java/com/realnet/Module/salesnew/" + module_name + "/entity/");
if(!file2.exists()) {
	file2.mkdirs();
}
File file3 = new File(angularProjectPath + "/src/main/java/com/realnet/Module/salesnew/" + module_name + "/repository/");
if(!file3.exists()) {
	file3.mkdirs();
}
File file4 = new File(angularProjectPath + "/src/main/java/com/realnet/Module/salesnew/" + module_name + "/responce/");
if(!file4.exists()) {
	file4.mkdirs();
}
File file5 = new File(angularProjectPath + "/src/main/java/com/realnet/Module/salesnew/" + module_name + "/service/");
if(!file5.exists()) {
	file5.mkdirs();
}
File file6 = new File(angularProjectPath + "/src/main/java/com/realnet/Module/salesnew/" + module_name + "/service/");
if(!file6.exists()) {
	file6.mkdirs();
}
File file7 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/add/" + module_name + "/");
if(!file7.exists()) {
	file7.mkdirs();
}
File file8 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/add/" + module_name + "/");
if(!file8.exists()) {
	file8.mkdirs();
}
File file9 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/add/" + module_name + "/");
if(!file9.exists()) {
	file9.mkdirs();
}
File file10 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/all/" + module_name + "/");
if(!file10.exists()) {
	file10.mkdirs();
}
File file11 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/all/" + module_name + "/");
if(!file11.exists()) {
	file11.mkdirs();
}
File file12 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/all/" + module_name + "/");
if(!file12.exists()) {
	file12.mkdirs();
}
File file13 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/readonly/" + module_name + "/");
if(!file13.exists()) {
	file13.mkdirs();
}
File file14 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/readonly/" + module_name + "/");
if(!file14.exists()) {
	file14.mkdirs();
}
File file15 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/readonly/" + module_name + "/");
if(!file15.exists()) {
	file15.mkdirs();
}
File file16 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/update/" + module_name + "/");
if(!file16.exists()) {
	file16.mkdirs();
}
File file17 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/update/" + module_name + "/");
if(!file17.exists()) {
	file17.mkdirs();
}
File file18 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/update/" + module_name + "/");
if(!file18.exists()) {
	file18.mkdirs();
}
File file19 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/" + module_name + "/");
if(!file19.exists()) {
	file19.mkdirs();
}
File file20 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/" + module_name + "/");
if(!file20.exists()) {
	file20.mkdirs();
}
File file21 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/" + module_name + "/");
if(!file21.exists()) {
	file21.mkdirs();
}
File file22 = new File(angularProjectPath + "/webui/src/app/pages/Module/sales-new/" + module_name + "/");
if(!file22.exists()) {
	file22.mkdirs();
}
