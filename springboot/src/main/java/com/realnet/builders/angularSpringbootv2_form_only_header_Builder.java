...
public class angularSpringbootv2_form_only_header_Builder {
 ...
 @Value("${angularProjectPath}")
	...
	@GetMapping(value = "/angularSpringbootv2_form_only_header_Builder")
...
"" + "\r\n" + 
"	// get all data" + "\r\n" + 
"	@ApiOperation(value = \"List of sales\", response = "+sbohresponce1+".class)" + "\r\n" + 
"	@GetMapping(path = \"/getsales\")" + "\r\n" + 
"	public "+sbohresponce1+" getdata(@RequestParam(value = \"page\", defaultValue = \"0\", required = false) Integer page," + "\r\n" + 
"			@RequestParam(value = \"size\", defaultValue = \"20\", required = false) Integer size) {" + "\r\n" + 
"		"+sbohresponce1+" resp = new "+sbohresponce1+"();" + "\r\n" + 
...
"                    <td><input id=\"name\" colspan=\"2\" type=\"text\" formControlName=\"name\" placeholder=\"Enter Name\"" + "\r\n" + 
"                            style=\"width:180px\"></td>" + "\r\n" + 
"                </tr>" + "\r\n" + 
"" + "\r\n" + 
"                <tr>" + "\r\n" + 
"                    <td style=\"width:125px;\">Department: </td>" + "\r\n" + 
"                    <td><input id=\"department\" colspan=\"2\" type=\"text\" formControlName=\"department\"" + "\r\n" + 
"                            placeholder=\"Enter Depertment\" style=\"width:180px\"></td>" + "\r\n" + 
"                </tr>" + "\r\n" + 
"" + "\r\n" + 
"" + "\r\n" + 
"                <tr>" + "\r\n" + 
"                    <td style=\"width:125px;\">Joining Date: </td>" + "\r\n" + 
"                    <td><input id=\"joining_date\" colspan=\"2\" type=\"date\" formControlName=\"joining_date\"" + "\r\n" + 
"                            placeholder=\"Enter joining date\" style=\"width:180px\"></td>" + "\r\n" + 
"                </tr>" + "\r\n" + 
"" + "\r\n" + 
"                <tr>" + "\r\n" + 
"                    <td style=\"width:125px;\">Status: </td>" + "\r\n" + 
"                    <td><input id=\"status\" colspan=\"2\" type=\"text\" formControlName=\"status\" placeholder=\"Enter Status\"" + "\r\n" + 
"                            style=\"width:180px\"></td>" + "\r\n" + 
"                </tr>" + "\r\n" + 
"" + "\r\n" + 
"            </table>" + "\r\n" + 
...
"                    <tr>" + "\r\n" + 
"                        <td style=\"width:125px;\">Name: </td>" + "\r\n" + 
"                        <td><input colspan=\"2\" type=\"text\" name=\"name\" [(ngModel)]=\"student.name\" style=\"width:120px\">" + "\r\n" + 
"                        </td>" + "\r\n" + 
"                    </tr>" + "\r\n" + 
"                    <tr>" + "\r\n" + 
"                        <td>Depertment: </td>" + "\r\n" + 
"                        <td colspan=\"2\"><input type=\"text\" name=\"depertment\" [(ngModel)]=\"student.department\"> </td>" + "\r\n" + 
"                    </tr>" + "\r\n" + 
"                    <tr>" + "\r\n" + 
"                        <td>DOJ:</td>" + "\r\n" + 
"                        <td colspan=\"2\"><input type=\"date\" name=\"joining_date\" [(ngModel)]=\"student.joining_date\"> </td>" + "\r\n" + 
"                    </tr>" + "\r\n" + 
"                    <tr>" + "\r\n" + 
"                        <td>Status:</td>" + "\r\n" + 
"                        <td colspan=\"2\"><input type=\"text\" name=\"status\" [(ngModel)]=\"student.status\"> </td>" + "\r\n" + 
"                    </tr>" + "\r\n" + 
"                </table>" + "\r\n" + 
"                <br>" + "\r\n" + 
"" + "\r\n" + 
...
"}" 
 ...
 sbohtsCode.append("" + "\r\n" + 
"" + "\r\n" + 
"export class "+sbohts2+" implements OnInit {"
+
"    id: number;" + "\r\n" + 
"    name: String;" + "\r\n" + 
"    department: String;" + "\r\n" + 
