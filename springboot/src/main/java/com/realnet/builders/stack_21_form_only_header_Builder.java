...
public class stack_21_form_only_header_Builder {
 ...
 @Value("${angularProjectPath}")
	...
	@GetMapping(value = "/stack_21_form_only_header_Builder")
...
String sbohresponse = ui_name +"SalesResponse.java";
String  mainstr3 = sbohresponse;
String sbohresponse1=mainstr3.replace(".java", "");
...
String sbohreadonlyhtml = ui_name + "readonly.component.html";
String  mainstr12 = sbohreadonlyhtml;
String sbohreadonlyhtml1=mainstr12.replace(".html", "");
...
String sbohnewts2=mainstr21.replace(".component.ts", "");
 ...
 "\n @RestController\r\n" + "public class " + controllerName + " {\r\n" 
		...
		btnservise.actionbuilderbutton( id,controllerName, technology_stack, file_location, sbohservice1, sbohentity1);
		
		
		// EXTRA BUTTON LOOP END
 StringBuilder sbohcontrollerCode = new StringBuilder();
 sbohcontrollerCode.append("package com.realnet.Module.salesnew.controller;" + "\r\n" + 
		 "" + "\r\n" + 
		 ...
		 "import com.realnet.Module.salesnew.repository."+sbohrepository1+";\r\n"+
		  "import com.realnet.Module.salesnew.responce."+sbohresponse1+";\r\n"+
...
"" + "\r\n" + 
"	// get all data" + "\r\n" + 
"	@ApiOperation(value = \"List of sales\", response = "+sbohresponse1+".class)" + "\r\n" + 
"	@GetMapping(path = \"/getsales\")" + "\r\n" + 
"	public "+sbohresponse1+" getdata(@RequestParam(value = \"page\", defaultValue = \"0\", required = false) Integer page," + "\r\n" + 
"			@RequestParam(value = \"size\", defaultValue = \"20\", required = false) Integer size) {" + "\r\n" + 
"		"+sbohresponse1+" resp = new "+sbohresponse1+"();" + "\r\n" + 
...
"" + "\r\n" + 
"			@RequestBody "+sbohentity1+" sale) {" + "\r\n" + 
"		// String filename=file.getOriginalFilename();" + "\r\n" + 
"		// System.err.println(filename);" + "\r\n" + 
"		// sale.setUploadprofile(filename);" + "\r\n" + 
"		//" + "\r\n" + 
"		"+sbohentity1+" data = this.saleservice.createsale(sale);" + "\r\n" + 
"		if (data == null) {" + "\r\n" + 
...
"" + "\r\n" + 
"	// get data by id" + "\r\n" + 
"	@ApiOperation(value = \"Get a sales\", response = "+sbohentity1+".class)" + "\r\n" + 
"	@GetMapping(\"/getsales/{id}\")" + "\r\n" + 
"	public ResponseEntity<"+sbohentity1+"> getbyid(@PathVariable(\"id\") Integer id) {" + "\r\n" + 
"		"+sbohentity1+" getid = this.saleservice.getid(id);" + "\r\n" + 
"		if (getid == null) {" + "\r\n" + 
...
"" + "\r\n" + 
"	// UPDATE" + "\r\n" + 
"	@ApiOperation(value = \"update a sale\", response = "+sbohentity1+".class)" + "\r\n" + 
"	@PutMapping(\"/getsales/{id}\")" + "\r\n" + 
"	public ResponseEntity<"+sbohentity1+"> updateTeacher(" + "\r\n" + 
"			@RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authToken," + "\r\n" + 
"			@PathVariable(value = \"id\") Integer id, @Valid @RequestBody "+sbohentity1+" sale) {" + "\r\n" + 
"" + "\r\n" + 
"		"+sbohentity1+" updatedsale = saleservice.updateById(id, sale);" + "\r\n" + 
...
"}" 
 ...
 sbohentityCode.append("package com.realnet.Module.salesnew.entity;" + "\r\n" + 
		 "" + "\r\n" + 
...
"@Entity" + "\r\n" + 
"@Table(name = \"sales\")" + "\r\n" + 
"public class " + sbohentity1+" extends Rn_AuditEntity{"+
"	" + "\r\n" + 
"	@Id" + "\r\n" + 
...
"}" 
 ...
 sbohrepositoryCode.append("package com.realnet.Module.salesnew.repository;" + "\r\n" + 
		 "" + "\r\n" + 
		 "" + "\r\n" + 
...
"}" 
 ...
 StringBuilder sbohresponseCode = new StringBuilder();
 sbohresponseCode.append("package com.realnet.Module.salesnew.responce;" + "\r\n" + 
		 "" + "\r\n" + 
		 "import java.util.List;" + "\r\n" + 
		 "" + "\r\n" + 
...
"public class " + sbohresponse1 + " extends PageResponse{"+
"	 @ApiModelProperty(required = true, value = \"\")" + "\r\n" + 
"	  private List<"+sbohentity1+"> sales;" + "\r\n" + 
"}" 
);

	File sbohresponseFile = new File(projectPath + "/Projects/" + project_name + "/src/main/java/com/realnet/Module/salesnew/responce/" + sbohresponse);
			System.out.println("Directory name = " + sbohresponseFile);
			File sbohresponseFileParentDir = new File(sbohresponseFile.getParent());
			if(!sbohresponseFileParentDir.exists()) {
				sbohresponseFileParentDir.mkdirs();
			}
			if (!sbohresponseFile.exists()) {
				sbohresponseFile.createNewFile();
			}
			fw = new FileWriter(sbohresponseFile.getAbsoluteFile());
			bw = new BufferedWriter(fw);
			bw.write(sbohresponseCode.toString());
			bw.close();

 StringBuilder sbohserviceCode = new StringBuilder();
 sbohserviceCode.append("package com.realnet.Module.salesnew.service;" + "\r\n" + 
		 "" + "\r\n" + 
		 "import org.springframework.data.domain.Page;" + "\r\n" + 
		 "import org.springframework.data.domain.Pageable;" + "\r\n" + 
		 "import com.realnet.Module.salesnew.entity."+sbohentity1+";\r\n"+
...
"<clr-icon shape=\"airplane\" size=\"32\"></clr-icon></a>   " + "\r\n" + 
" </div>" + "\r\n" + 
"" + "\r\n" + 
...
"}" 
 ...
 sbohalltsCode.append("import { Component, OnInit, TemplateRef, ViewChild } from '@angular/core';" + "\r\n" + 
...
"" 
 ...
 StringBuilder sbohreadonlyhtmlCode = new StringBuilder();
 sbohreadonlyhtmlCode.append("<div class=\"read-only-pg pad-16\">" + "\r\n" + 
...
"		" + "\r\n" 	 );
 ...
 for (Rn_Fb_Line rn_Fb_linefield : rn_fb_lines) {
 	 ...
 	 if(rn_Fb_linefield.getType_field().equals("textfield"))
 	 {
 		...
 		sbohreadonlyhtmlCode.append("        <tr>" + "\r\n" + 
...
"    </div>" 
	...
	File sbohreadonlyhtmlFile = new File(projectPath + "/Projects/" + project_name + "/webui/src/app/pages/Module/sales-new/readonly/" + sbohreadonlyhtml);
			System.out.println("Directory name = " + sbohreadonlyhtmlFile);
			File sbohreadonlyhtmlFileParentDir = new File(sbohreadonlyhtmlFile.getParent());
			if(!sbohreadonlyhtmlFileParentDir.exists()) {
				sbohreadonlyhtmlFileParentDir.mkdirs();
			}
			if (!sbohreadonlyhtmlFile.exists()) {
				sbohreadonlyhtmlFile.createNewFile();
			}
			fw = new FileWriter(sbohreadonlyhtmlFile.getAbsoluteFile());
			bw = new BufferedWriter(fw);
			bw.write(sbohreadonlyhtmlCode.toString());
			bw.close();
...
"<div class=\"container\">" + "\r\n" + 
"    <h3 class=\"center\"><b>Group Edit Form</b></h3>" + "\r\n" + 
"    <br />" + "\r\n" + 
"" + "\r\n" + 
...
"	" + "\r\n" + 
"					<!-- EXTENSION FIELDS START -->" + "\r\n" + 
"					<teacher-edit-extension [(teacherExtension)]=\"student\"></teacher-edit-extension>" + "\r\n" + 
"					<!-- EXTENSION FIELDS END-->" + "\r\n" + 
"               " + "\r\n" + 
...
"}" 
 ...
 sbohtsCode.append("" + "\r\n" + 
"" + "\r\n" + 
"export class "+sbohts2+"Component {"
+
"    id: number;" + "\r\n" + 
"   " + "\r\n" );
