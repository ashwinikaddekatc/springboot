...
import { TestonlyheadersalesnewComponent } from './pages/Module/sales-new/Testonlyheadersalesnew.component';
import { TestonlyheaderallComponent } from './pages/Module/sales-new/all/Testonlyheaderall.component';
import { TestonlyheaderaddComponent } from './pages/Module/sales-new/add/Testonlyheaderadd.component';
import { TestonlyheaderreadonlyComponent } from './pages/Module/sales-new/readonly/Testonlyheaderreadonly.component';
import { TestonlyheaderupdateComponent } from './pages/Module/sales-new/update/Testonlyheaderupdate.component';
...
export const routes: Routes = [
  ...
  { path: '', redirectTo: '/home/dashboard/order', pathMatch: 'full' },
  {
    ...
    children: [  // Children paths are appended to the parent path
      ...
      {
        path: 'test-form', component: TestonlyheadersalesnewComponent,
        children: [
          { path: '', redirectTo: 'all', pathMatch: 'full' },
          { path: 'all', component: TestonlyheaderallComponent },
          { path: 'add', component: TestonlyheaderaddComponent },
          { path: 'readonly/:id', component: TestonlyheaderreadonlyComponent },
          { path: 'edit/:id', component: TestonlyheaderupdateComponent }
        ]
      },
      // Rule Library Start
      {
