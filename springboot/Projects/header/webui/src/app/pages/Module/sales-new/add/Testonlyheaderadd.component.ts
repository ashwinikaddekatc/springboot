...
@Component({
  selector: 'app-add',
 templateUrl: './Testonlyheaderadd.component.html',  styleUrls: ['./Testonlyheaderadd.component.scss']})
export class TestonlyheaderaddComponent implements OnInit {  //create a object of entry form
