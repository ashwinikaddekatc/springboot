...
@Component({
  selector: 'app-edit',
 templateUrl: './Flf_buildereditsales.component.html',  styleUrls: ['./Flf_buildereditsales.component.scss']})
export class Flf_buildereditsalesComponent implements OnInit {  updated = false;
  sales ;
  sid: number;
  salesperson;
