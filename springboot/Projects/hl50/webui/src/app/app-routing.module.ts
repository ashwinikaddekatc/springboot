...
import { HlnewsalesnewComponent } from './pages/Module/sales-new/Hlnewsalesnew.component';
import { HlnewallsalesComponent } from './pages/Module/sales-new/all/Hlnewallsales.component';
import { HlnewaddsalesComponent } from './pages/Module/sales-new/addsales/Hlnewaddsales.component';
import { HlnewreadonlynewComponent } from './pages/Module/sales-new/readonly/Hlnewreadonlynew.component';
import { HlneweditsalesComponent } from './pages/Module/sales-new/edit/Hlneweditsales.component';
...
export const routes: Routes = [
  ...
  { path: '', redirectTo: '/home/dashboard/order', pathMatch: 'full' },
  {
    ...
    children: [  // Children paths are appended to the parent path
      ...
      {
        path: 'department', component: HlnewsalesnewComponent,
        children: [
          { path: '', redirectTo: 'all', pathMatch: 'full' },
          { path: 'all', component: HlnewallsalesComponent },
          { path: 'add', component: HlnewaddsalesComponent },
          { path: 'readonly/:id', component: HlnewreadonlynewComponent },
          { path: 'edit/:id', component: HlneweditsalesComponent },
        ]
      },
