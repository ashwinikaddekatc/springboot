...
import { Testonlyheadersales } from "./pages/Module/sales-new/Testonlyheadersales";
...
@NgModule({
  ...
  declarations: [
    ...
    AlldepartComponent,
    // action builder,
    TestonlyheaderaddComponent,
    TestonlyheaderallComponent,
    TestonlyheaderreadonlyComponent,
    TestonlyheadersalesnewComponent,
    TestonlyheaderupdateComponent
