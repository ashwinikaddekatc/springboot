...
@Component({
 ...
 templateUrl: './Test_19readonly.component.html',  styleUrls: ['./Test_19readonly.component.scss']})
export class Test_19readonlyComponent implements OnInit {   basic: boolean = false;
  sales;
  header_id;
