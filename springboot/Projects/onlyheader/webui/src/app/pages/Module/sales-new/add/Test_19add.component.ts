...
@Component({
  selector: 'app-add',
 templateUrl: './Test_19add.component.html',  styleUrls: ['./Test_19add.component.scss']})
export class Test_19addComponent implements OnInit {  //create a object of entry form
