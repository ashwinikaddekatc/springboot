...
@Component({
  selector: 'app-update',
 templateUrl: './Testonlyheaderupdate.component.html',  styleUrls: ['./Testonlyheaderupdate.component.scss']})
export class TestonlyheaderupdateComponent implements OnInit {
  header_id;
  //student;
