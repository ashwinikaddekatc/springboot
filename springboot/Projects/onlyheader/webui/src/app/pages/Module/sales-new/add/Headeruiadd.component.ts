...
@Component({
  selector: 'app-add',
 templateUrl: './Headeruiadd.component.html',  styleUrls: ['./Headeruiadd.component.scss']})
export class HeaderuiaddComponent implements OnInit {  //create a object of entry form
