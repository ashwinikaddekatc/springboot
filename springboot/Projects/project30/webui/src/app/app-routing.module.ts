...
import { Day30wireframesalesnewComponent } from './pages/Module/sales-new/Day30wireframesalesnew.component';
import { Day30wireframeaddComponent } from './pages/Module/sales-new/add/Day30wireframeadd.component';
import { Day30wireframeallComponent } from './pages/Module/sales-new/all/Day30wireframeall.component';
import { Day30wireframereadonlyComponent } from './pages/Module/sales-new/readonly/Day30wireframereadonly.component';
import { Day30wireframeupdateComponent } from './pages/Module/sales-new/update/Day30wireframeupdate.component';
...
export const routes: Routes = [
  ...
  { path: '', redirectTo: '/home/dashboard/order', pathMatch: 'full' },
  {
    ...
    children: [  // Children paths are appended to the parent path
      ...
      {
        path: 'test-wireframe', component: Day30wireframesalesnewComponent,
        children: [
          { path: '', redirectTo: 'all', pathMatch: 'full' },
          { path: 'all', component: Day30wireframeallComponent },
          { path: 'add', component: Day30wireframeaddComponent },
          { path: 'readonly/:id', component: Day30wireframereadonlyComponent },
           { path: 'edit/:id'   , component: Day30wireframeupdateComponent }, 
        ]
      }
