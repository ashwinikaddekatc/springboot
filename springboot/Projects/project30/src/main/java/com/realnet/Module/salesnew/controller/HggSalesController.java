package com.realnet.comm.testmodule30.controller;
...
@RequestMapping("/api")
@Api(tags = { "Sales" })
public class HggSalesController{
	@Autowired
	...
	public SalesResponse getdata(@RequestParam(value = "page", defaultValue = "0", required = false) Integer page,
		...
		Page<Hggsales> result = this.saleservice.getlist(paging);
	...
	// add data
	@ApiOperation(value = "add a sales", response = Hggsales.class)
