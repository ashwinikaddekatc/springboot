...
@Component({
  selector: 'app-all',
 templateUrl: './Cust_detailsall.component.html',  styleUrls: ['./Cust_detailsall.component.scss']})
export class Cust_detailsall implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.columns = [
      ...
      { prop: "label5", name: "label5", width: 150 },
    ];
  }
