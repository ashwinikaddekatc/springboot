...
@Component({
  selector: 'app-add',
 templateUrl: './Cust_detailsadd.component.html',  styleUrls: ['./Cust_detailsadd.component.scss']})
export class Cust_detailsadd implements OnInit {  //create a object of entry form
