...
public class Rn_Menu_Group_Controller {
	...
	public ResponseEntity<Rn_Menu_Group_Header> getMenuGroupById(@PathVariable(value = "id") Integer id) {
...
//		rn_menu_group_header.setAccountId(userId);
	...
	public ResponseEntity<Rn_Menu_Group_Header> updateMenuGroup(
			@RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authToken,
			@PathVariable(value = "id") Integer id, @Valid @RequestBody Rn_Menu_Group_Header rn_menu_group_header) {
//		String userId = tokenUtil.getUserId(authToken);
//		rn_menu_group_header.setUpdatedBy(userId);
	...
	public ResponseEntity<Map<String, Boolean>> deleteMenuGroup(@PathVariable(value = "id") Integer id) {
	...
	public ResponseEntity<?> getMenus(
		...
		int menu_group_id = user.getMenu_group_id();
