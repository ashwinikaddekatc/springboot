...
import { ResetPasswordRequest } from "src/app/pages/password-reset/password-reset.component";

import { EmailRequest } from "src/app/pages/user-registration/user-registration.component";
