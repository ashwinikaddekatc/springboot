...
@Component({
 ...
 templateUrl: './Abtuireadonly.component.html',  styleUrls: ['./Abtuireadonly.component.scss']})
export class AbtuireadonlyComponent implements OnInit {   basic: boolean = false;
  sales;
  header_id;
