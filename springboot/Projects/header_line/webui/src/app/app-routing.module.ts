...
import { Flf_uiaddsalesComponent } from "./pages/Module/sales-new/addsales/Flf_uiaddsales.component";
import { Flf_uiallComponent } from "./pages/Module/sales-new/all/Flf_uiall.component";
import { Flf_uieditComponent } from "./pages/Module/sales-new/edit/Flf_uiedit.component";
import { Flf_uireadonlynewComponent } from "./pages/Module/sales-new/readonly/Flf_uireadonlynew.component";
import { Flf_uisalesnewComponent } from "./pages/Module/sales-new/Flf_uisalesnew.component";
...
export const routes: Routes = [
  ...
  { path: '', redirectTo: '/home/dashboard/order', pathMatch: 'full' },
  {
    ...
    children: [  // Children paths are appended to the parent path
     ...
     // Sale new
      {
        path: 'sales-new', component: Flf_uisalesnewComponent, data: [{ selectedHeaderItemIndex: 5, selectedSubNavItemIndex: -1 }],
        children: [
          { path: '', redirectTo: 'all', pathMatch: 'full' },
          { path: 'all', component: Flf_uiallComponent },
          { path: 'addsales', component: Flf_uiaddsalesComponent },
          { path: 'readsales/:id', component: Flf_uireadonlynewComponent },
          { path: 'update/:id', component: Flf_uieditComponent },
        ]
      },
