...
import { ExtfieldsComponent } from './pages/Module/departmentnew/extfields/extfields.component';
import { HeaderextComponent } from './pages/Module/departmentnew/extfields/headerext.component';
...
@NgModule({
  ...
  declarations: [
    ...
    Line_onlydepartmentnewComponent,
    Line_onlyaddlinedepartComponent,
    Line_onlyalldepartComponent,
    Line_onlyeditdepartComponent,
    Line_onlyreadonlydepartComponent,
    ExtfieldsComponent,
    HeaderextComponent
