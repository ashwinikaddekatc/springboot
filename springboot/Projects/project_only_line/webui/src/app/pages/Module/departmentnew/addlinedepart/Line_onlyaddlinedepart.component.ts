...
@Component({
 ...
 templateUrl: './Line_onlyaddlinedepart.component.html',  styleUrls: ['./Line_onlyaddlinedepart.component.scss']})
export class Line_onlyaddlinedepartComponent implements OnInit {
