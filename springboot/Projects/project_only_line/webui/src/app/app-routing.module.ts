...
import { Line_onlydepartmentnewComponent } from './pages/Module/departmentnew/Line_onlydepartmentnew.component';
import { Line_onlyalldepartComponent } from './pages/Module/departmentnew/alldepart/Line_onlyalldepart.component';
import { Line_onlyaddlinedepartComponent } from './pages/Module/departmentnew/addlinedepart/Line_onlyaddlinedepart.component';
import { Line_onlyreadonlydepartComponent } from './pages/Module/departmentnew/readonlydepart/Line_onlyreadonlydepart.component';
import { Line_onlyeditdepartComponent } from './pages/Module/departmentnew/editdepart/Line_onlyeditdepart.component';
...
export const routes: Routes = [
  ...
  { path: '', redirectTo: '/home/dashboard/order', pathMatch: 'full' },
  {
    ...
    children: [  // Children paths are appended to the parent path
      ...
      {
        path: 'department', component: Line_onlydepartmentnewComponent, data: [{ selectedHeaderItemIndex: 5, selectedSubNavItemIndex: -1 }],
        children: [
          { path: '', redirectTo: 'all', pathMatch: 'full' },
          { path: 'all', component: Line_onlyalldepartComponent, data: [{ selectedHeaderItemIndex: 5, selectedSubNavItemIndex: -1 }] },
          { path: 'adddept', component: Line_onlyaddlinedepartComponent, data: [{ selectedHeaderItemIndex: 5, selectedSubNavItemIndex: -1 }] },
          { path: 'readdep/:did', component: Line_onlyreadonlydepartComponent, data: [{ selectedHeaderItemIndex: 5, selectedSubNavItemIndex: -1 }] },
          { path: 'editdep/:did', component: Line_onlyeditdepartComponent, data: [{ selectedHeaderItemIndex: 5, selectedSubNavItemIndex: -1 }] },
        ]
      },
