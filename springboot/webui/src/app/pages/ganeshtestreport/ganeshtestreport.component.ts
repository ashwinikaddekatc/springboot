...
@Component({
  selector: 'ganeshtestreport',
  templateUrl: './ganeshtestreport.component.html',
  styleUrls: ['./ganeshtestreport.component.scss']
})
export class ganeshtestreport implements OnInit {
...
std1:string;
 ...
 this.std1=" and author.afname="+name;
...
std2:string;
 ...
 this.std2=" and author.id="+name;
      
}
  strString1:string;
  strString2:string;      onAddstdPara() {
if(this.std1!==null || this.std1!==undefined){
        ...
        }        (<FormControl> this.entryForm.controls['para_pane']).setValue(this.strString1+this.strString2);
        }stdParamCmplt:string;
      onAddAdhoc() {
        console.log(this.v);
        
        this.stdParamCmplt=this.strString1+this.strString2;
