...
@Component({
  selector: 'entityreporttest',
  templateUrl: './entityreporttest.component.html',
  styleUrls: ['./entityreporttest.component.scss']
})
export class entityreporttest implements OnInit {
