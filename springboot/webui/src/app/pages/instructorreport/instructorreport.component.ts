...
@Component({
  selector: 'instructorreport',
  templateUrl: './instructorreport.component.html',
  styleUrls: ['./instructorreport.component.scss']
})
export class instructorreport implements OnInit {
