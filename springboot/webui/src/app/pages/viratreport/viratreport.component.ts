...
@Component({
  selector: 'viratreport',
  templateUrl: './viratreport.component.html',
  styleUrls: ['./viratreport.component.scss']
})
export class viratreport implements OnInit {
...
std1:string;
 ...
 this.std1=" and products.id="+name;
...
std2:string;
 ...
 this.std2=" and products.category="+name;
...
std3:string;
 ...
 this.std3=" and products.discontinued="+name;
